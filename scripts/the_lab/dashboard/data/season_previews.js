...
const SEASON_PREVIEWS = {
  RCB: {
    ...
    byTheNumbers: [
      { value: '8.73', label: 'RCB\'s 2025 powerplay bowling economy', context: 'Down from 9.77 in 2024. A run-per-over improvement that rewired the entire franchise' },
      { value: '183.3', label: 'Kohli\'s death SR (114 balls, MEDIUM)', context: 'Comes from batting through in 15/44 innings, not as a designated finisher' },
      { value: '-39.9', label: 'Patidar\'s SR delta (last 10 vs since-2023)', context: 'The new captain\'s batting form is the squad\'s biggest concern' },
      { value: '7.45', label: 'Krunal\'s middle-overs economy (82 overs, MEDIUM)', context: '1.44 runs per over below the league average. The invisible engine' },
      { value: '1.4 / 10', label: 'Off-spin depth chart rating', context: 'No frontline off-spinner in the squad. Leg-spin covered (Suyash), but off-spin remains the genuine gap' }
    ],
    categoryRatings: [
      // Phase Performance
      ...
      // Squad Structure
      { cat: 'Squad Depth', rating: 5.5, metric: '~5 bench options', note: 'Off-spin depth 1.4/10. Padikkal showing form (151.5 L10 SR, rebounding); Bethell limited IPL exposure. One Bhuvneshwar injury and there is no like-for-like replacement', group: 'structure' },
      { cat: 'XII Completeness', rating: 6.5, metric: '5/7 key roles', note: 'Openers, middle order, finishers, PP pace, middle-overs spin covered. Leg-spin covered by Suyash Sharma. Missing: frontline off-spinner, dedicated death specialist. Dayal availability uncertain', group: 'structure' },
      ...
      { cat: 'Bowling Variety', rating: 5.5, metric: '4 types in XII', note: 'Leg-spin covered (Suyash), no frontline off-spin, only 1 left-arm option (Krunal). If Dayal unavailable, zero left-arm pace. Off-spin is the genuine gap', group: 'structure' },
      ...
      // Overall
      { cat: 'Overall', rating: 6.9, metric: '', note: 'Phase performance (avg 7.0) offset by structural gaps in depth and XII completeness. Sharp peaks mask uncomfortable valleys. A team built for Plan A; the question is what happens when Plan A fails.' }
    ],
    boldTake: {
    ...
    sections: [
      // ── 1. THE STORY ──────────────────────────────────────────────
      {
        id: 'story',
        title: 'The Story',
        summary: 'How RCB transformed from a batting-obsessed franchise into bowling-first champions in 2025, and the questions facing their title defence.',
        blocks: [
      ...
      // ── 2. OFF-SEASON CHANGES ─────────────────────────────────────
      {
        ...
        summary: 'Patidar stays as captain. Livingstone and Ngidi depart. 15 players retained with 6 auction purchases totaling 10.65 Cr.',
        blocks: [
          { type: 'subheading', content: 'Captaincy' },
          { type: 'text', content: '<p>Rajat Patidar stays on as captain after leading RCB to the promised land in 2025. His batting position at number 4 gives him a tactical vantage point, and winning a title tends to silence any dressing-room debate about authority. The continuity matters here: no leadership disruption heading into a title defence.</p>' },
      ...
      // ── 4. FULL SQUAD TABLE ───────────────────────────────────────
      {
        id: 'squad',
        title: 'Full Squad',
        summary: '25-player squad at 116.95 Cr total salary. 4 overseas slots in the predicted XII (Salt, David, Hazlewood, Shepherd/Bethell/Duffy).',
        blocks: [
      ...
      // ── 5. TEAM STYLE ANALYSIS ────────────────────────────────────
      {
        ...
        summary: 'RCB transformed from a batting-first team conceding 9.77 in the powerplay (2024) to a bowling-first unit at 8.73 (2025). Two different franchises.',
        blocks: [
          ...
          { type: 'subheading', content: '2024: Still Living in the Past' },
          {
            type: 'table',
          ...
          { type: 'subheading', content: '2025: Somebody Read the Memo' },
          {
            type: 'table',
      ...
      // ── 6. TEAM BATTING PROFILE ───────────────────────────────────
      {
        ...
        summary: 'RCB dominate pace bowling (+8.7 to +9.6 SR vs league) but underperform against off-spin (-1.5). Middle overs against spin are the trapdoor.',
        blocks: [
      ...
      {
        id: 'inningsContext',
        title: 'Innings Context',
        summary: 'RCB are two different teams depending on innings: 61.1% chase win rate vs 53.8% setting. Elite at chasing targets under 180 (8/8), but crumble above 200 (1/6).',
        blocks: [
          ...
          // Individual Player Splits - Batters
          ...
          // Individual Player Splits - Bowlers
          ...
          // Chase Results by Target Band
          { type: 'subheading', content: 'Chase Results by Target Band (Since 2023)' },
          {
            type: 'table',
          ...
          { type: 'callout', content: 'RCB are elite at chasing achievable targets but crumble when asked to go beyond their natural run rate. The bowling needs to keep targets below 180 for the batting to function at full capacity.' },
          ...
          // Early Wickets
          { type: 'subheading', content: 'Early Wickets: The 1-Wicket Sweet Spot' },
          {
            type: 'table',
          ...
          // Who Scales
          { type: 'subheading', content: 'Who Scales and Who Doesn\'t' },
          {
            type: 'table',
          ...
          { type: 'callout', content: 'If the coaching staff want one operational priority for 2026 chase preparation: train the middle order to survive the 8-15 over block when the required rate exceeds 10 per over. That is where chases die.' }
        ]
      },
      ...
      // ── 8. VENUE ANALYSIS ─────────────────────────────────────────
      {
        ...
        summary: 'The Chinnaswamy is a middle-and-death-overs paradise, not a powerplay one. Powerplay run rate (-0.17 vs league) actually suits RCB\'s bowling attack.',
        blocks: [
          ...
          { type: 'subheading', content: 'Chinnaswamy Phase Profile (Since 2023, aggregated across innings)' },
          {
            type: 'table',
          ...
          { type: 'subheading', content: 'How RCB\'s Strengths Fit the Venue' },
          { type: 'text', content: '<p>The powerplay bowling (8.73 economy in 2025) should thrive on a ground where the powerplay is actually not as scary as everyone assumes.</p><p>Krunal Pandya\'s 7.45 middle-overs economy is 1.84 runs per over below the venue average in that phase. That\'s not a bowler; that\'s a force field.</p><p>Death batting (David, Jitesh, Kohli) is perfectly suited to the Chinnaswamy\'s elevated death-overs scoring.</p><p>The risk: if opponents target RCB\'s thin spin depth in the middle overs, the venue\'s elevated scoring rate will turn a problem into a crisis.</p>' }
        ]
      },
      ...
      // ── 9. SCHEDULE ANALYSIS ──────────────────────────────────────
      {
        ...
        blocks: [
          ...
          { type: 'text', content: '<p>When the schedule drops, this section will cover:</p><p><strong>Home/away split:</strong> How many Chinnaswamy matches vs. away games, and what that means for squad selection (seam-heavy at home, spin rotation away).</p><p><strong>Cluster analysis:</strong> Whether RCB face top-4 contenders in bunches or nicely spread out.</p><p><strong>Rest days:</strong> Particularly relevant for Bhuvneshwar\'s workload management at 36 and Hazlewood\'s availability windows.</p><p><strong>Travel burden:</strong> Distance between consecutive venues and its impact on recovery.</p><p><strong>Early vs. late difficulty:</strong> Whether the tough fixtures come before the squad has settled its best XII.</p>' },
      ...
      // ── 10. HEAD-TO-HEAD RECORD ───────────────────────────────────
      {
        ...
        summary: 'Since 2023: 25-19 (56.8%). All-time: 132-138 (48.9%). KKR (1-4) is the nightmare matchup; PBKS (6-1) is the punching bag.',
        blocks: [
          ...
          { type: 'subheading', content: 'What the Numbers Say' },
      ...
      // ── 11. PLAYERS TO WATCH ──────────────────────────────────────
      {
        ...
        summary: 'Four spotlight players: Phil Salt (the human powerplay), Rajat Patidar (the weight of the crown), Bhuvneshwar Kumar (the man holding the building up), and Krunal Pandya (the invisible engine).',
        blocks: [
      ...
      // ── 12. PLAYERS WHO NEED TO STEP UP ───────────────────────────
      {
        id: 'playersStepUp',
        title: 'Players Who Need to Step Up',
        summary: 'Three development priorities: Devdutt Padikkal (middle-overs left-hand option), Venkatesh Iyer (converting KKR pedigree to RCB impact), and Suyash Sharma (maintaining middle-overs excellence).',
        blocks: [
          { type: 'subheading', content: '1. Devdutt Padikkal: The Middle-Overs Missing Piece' },
      ...
      // ── 13. RECENT FORM ───────────────────────────────────────────
      {
        id: 'recentForm',
        title: 'Recent Form',
        summary: 'Cross-format T20 form reveals Salt at 128.1 SR in ILT20 (current-form dip from 180.2 IPL), Jitesh surging at 195.1 weighted SR, Shepherd at 147.8 (adequate for No. 7/8). Patidar (-39.9) remains the red flag.',
        blocks: [
          { type: 'subheading', content: 'Batters (Cross-Format T20 Recent Form)' },
          { type: 'text', content: '<p><em>Last 10 T20 matches across all tournaments. Weights derived using 5-factor composite model (PQI, Competitiveness, Recency, Conditions, Sample Confidence). Franchise league weights Founder-approved; bilateral T20I weights computed per-series. Weighted SR = SUM(runs x weight) / SUM(balls x weight) x 100.</em></p>' },
          {
            type: 'table',
            headers: ['Player', 'Weighted SR', 'Raw SR', 'IPL SR', 'L10 Breakdown', 'Trend'],
            rows: [
              ['Virat Kohli', '144.5', '144.5', '144.5', 'IPL 2025 (10)', 'Stable-elite'],
              ['Phil Salt', '128.1', '128.1', '180.2', 'ILT20 2025/26 (10)', 'Current-form dip'],
              ['Jitesh Sharma', '195.1', '191.0', '176.6', 'IPL 2025 (6), SA tour of Ind (2), Ind tour of Aus (2)', 'Career-best'],
          ...
          { type: 'text', content: '<p><em>Weights: IPL (0.87), SMAT (0.65), BBL (0.53), ILT20 (0.49). Bilateral T20I per-series: Ind tour of Aus (0.58), SA tour of Ind (0.53), Aus tour of NZ (0.53), SA tour of Aus (0.50).</em></p>' },
          { type: 'text', content: '<p><strong>What the Cross-Format Picture Changes:</strong> The biggest revelation is <strong>Phil Salt</strong>. His IPL L10 of 180.2 SR was from April-June 2025 — seven months ago. His current form, all 10 recent T20s from ILT20 2025/26 (0.49), shows 128.1 SR. UAE conditions — flat tracks, shorter Sharjah boundaries — are friendlier than IPL venues, making 128.1 a genuine current-form dip, not a conditions adjustment.</p>' },
          { type: 'text', content: '<p><strong>Jitesh Sharma</strong> is the inverse story. His weighted L10 (195.1) is above raw (191.0) because 6 of 10 matches are IPL (0.87 weight). His SA tour of India matches carry 0.53 weight (played in India, high conditions similarity) and India tour of Australia carries 0.58 (93% IPL player overlap — the highest bilateral weight). <strong>Tim David</strong> at 167.7 across BBL (0.53), ILT20 (0.49), and Ind tour of Aus (0.58) is genuinely strong across three continents.</p>' },
          { type: 'text', content: '<p><strong>Venkatesh Iyer</strong> has the most data-limited L10: 7 IPL matches (Apr-May 2025) plus 3 SMAT 2024/25 matches from December 2024 — 14 months old. His IPL SR of 162.1 is the primary signal; the SMAT data adds domestic noise from a different season. <strong>Shepherd</strong> at 147.8 SR is adequate for a No. 7/8 allrounder (global franchise average: 140-160 SR). His IPL 260.7 is from just 28 balls. <strong>Krunal</strong> batted 59 balls in 4/10 matches — insufficient for SR analysis. <strong>Patidar</strong> (120.8) remains the red flag: -39.9 SR delta from career average.</p>' },
          { type: 'subheading', content: 'Bowlers (Cross-Format T20 Recent Form)' },
          {
            ...
            rows: [
              ['Josh Hazlewood', '8.37', '8.20', '9.32', '18', 'IPL 2025 (3), SA tour of Aus (3), Aus tour of NZ (2), Ind tour of Aus (2)', 'Peak form'],
          ...
          { type: 'text', content: '<p><strong>Hazlewood is the standout.</strong> His L10 spans 4 different series: IPL (3, weight 0.87), SA tour of Aus (3, 0.50), Aus tour of NZ (2, 0.53), Ind tour of Aus (2, 0.58). Weighted economy (8.37) is above raw (8.20) because the 3 IPL matches — where he went at 9.32 — carry the highest weight. Even so, 8.37 across four conditions sets with 18 wickets is excellent. Krunal at 7.17 (all IPL, 10 matches) is the best economy in the squad. Shepherd at 8.15 in ILT20 is significantly better than his IPL 11.21.</p>' },
          ...
          { type: 'text', content: '<p>The individual phase numbers confirm the structural fault line: death bowling. Both Hazlewood (10.65) and Bhuvneshwar (10.96) become expensive at the death, and Yash Dayal\'s 11.73 death economy is the most concerning number in the entire bowling unit.</p>' },
          { type: 'text', content: '<p><em><strong>Data Coverage:</strong> Statistics drawn from Cricsheet ball-by-ball T20 archive (9,496 matches through Jan 31, 2026). Tournaments: IPL (2008-2025), BBL (2011-2026), ILT20 (2023-2026), SMAT (2016-2024/25, partial), CPL, PSL, The Hundred, SA20, Super Smash, and international T20s. SMAT 2025/26 not yet available. Vijay Hazare (List A) not covered — T20-only database.</em></p>' }
        ]
      },

      // ── 14. MOMENTUM & SCORING TENDENCIES ─────────────────────────
      {
        id: 'momentum',
        title: 'Momentum & Scoring Tendencies',
        summary: 'Kohli and Salt are elite dot-ball avoiders (-7-9% vs league). Shepherd and David are power-first (6:4 ratio >1.0). Over 14 is RCB\'s surge over (+2.32 RPO vs league).',
        blocks: [
          ...
          { type: 'subheading', content: 'Dot Ball Discipline: Who Rotates, Who Stalls' },
          {
            ...
            rows: [
              ['Virat Kohli', '33.5%', '42.2%', '22.5%', '29.3%', '21.1%', '28.1%'],
              ['Phil Salt', '37.8%', '42.2%', '24.3%', '29.3%', '—', '—'],
              ['Rajat Patidar', '40.5%', '42.2%', '28.3%', '29.3%', '28.5%', '28.1%'],
              ['Jitesh Sharma', '72.7%', '42.2%', '35.1%', '29.3%', '25.2%', '28.1%'],
              ['Tim David', '—', '—', '33.0%', '29.3%', '28.7%', '28.1%'],
              ['Krunal Pandya', '60.5%', '42.2%', '25.5%', '29.3%', '25.5%', '28.1%']
            ]
          },
          { type: 'text', content: '<p>Kohli is the most efficient dot-ball avoider in the squad — 7-9% below league average across all three phases. He rotates, nudges, works gaps. Salt mirrors this efficiency in the powerplay and middle overs. Together, they explain why RCB\'s team dot ball rate in the powerplay (37.8%) is 4.4% below the league average.</p>' },
          { type: 'subheading', content: 'Big Over Profiles: Detonators vs. Accumulators' },
          {
            type: 'table',
            headers: ['Player', '15+ Run Over Rate', 'Six-to-Four Ratio', 'Death Boundary %', 'Profile'],
            rows: [
              ['Romario Shepherd', '33.3% (small)', '1.10', '47.7%', 'Pure detonator'],
          ...
          { type: 'text', content: '<p>The six-to-four ratio is revealing. Shepherd (1.10) and David (1.02) hit more sixes than fours — genuine power hitters who clear the boundary more often than they pierce it. Patidar matches that ratio (1.02), suggesting his big-hitting is more evolved than his recent form might indicate. Salt is a boundary accumulator (0.46 ratio). Kohli at 0.38 is the purest rotator — his runs come from precision placement, not brute force.</p>' },
          { type: 'subheading', content: 'Team Momentum Patterns' },
          { type: 'text', content: '<p>RCB generates 14.5% of overs at 15+ runs (vs 13.2% league average). <strong>Over 14 is RCB\'s surge over:</strong> 11.25 RPO vs 8.93 league (+2.32). <strong>Over 13 is a cold spot:</strong> 7.67 RPO vs 8.75 league (-1.08). After a big over (12+ runs), only 7.3% of next overs are dot-heavy (4+ dots) compared to 10.7% after a normal over. RCB sustains momentum — once they start hitting, they don\'t stop.</p>' }
        ]
      },

      // ── 15. TACTICAL BLUEPRINT ──────────────────────────────────────
      {
        id: 'tactical',
        title: 'Tactical Blueprint',
        summary: 'Batting order is rigid (Salt/Kohli always open, Patidar locked at #4). Bowling follows a fixed template: pace PP, 60% spin in middle, Hazlewood saves overs for death (over 19: 6.75 econ, 5 wkts).',
        blocks: [
          { type: 'subheading', content: 'Batting Order: Rigid at the Top, Situational in the Middle' },
          {
            type: 'table',
            headers: ['Batter', 'Avg Pos', 'Most Common', 'Avg Entry Over', 'Under Pressure (2+ PP wkts)'],
            rows: [
              ['Phil Salt', '1.0', '#1 (100%)', '1.0', 'Always opens'],
              ['Virat Kohli', '1.3', '#1 (66%), #2 (30%)', '1.0', 'Always opens'],
              ['Rajat Patidar', '3.9', '#4 (74%)', '4.4 / 7.1 pressure', 'Drops to #4, enters later'],
              ['Tim David', '6.7', '#7 (42%)', '14.9', 'Always death, team ~141'],
              ['Jitesh Sharma', '5.6', '#5-6 range', '11.9', 'Flexible, overs 4-16'],
              ['Krunal Pandya', '7.0', '#7 (55%)', '12.0', 'Team ~111 at entry']
            ]
          },
          { type: 'text', content: '<p>Salt and Kohli always open — no exceptions across 44 innings. Patidar is locked at #4 in 74% of innings. <strong>Patidar is the key flex player:</strong> in stable starts he enters at over 4.4; under pressure (2+ PP wickets) he drops to #4 and enters at over 7.1 — a stabilizer, not an accelerator. Tim David enters at over 14.9 on average, a pure death hitter. The order barely changes between setting and chasing.</p>' },
          { type: 'subheading', content: 'Bowling Deployment: The 20-Over Template' },
          {
            type: 'table',
            headers: ['Phase', 'Pace %', 'Spin %', 'Key Pattern'],
            rows: [
              ['Powerplay (1-6)', '77-96%', '4-21%', 'Near-total pace dominance'],
              ['Middle (7-15)', '25-59%', '41-73%', 'Spin-first: ~60% spin, ~5.4 spin overs/match'],
              ['Death (16-20)', '60-90%', '10-40%', 'Return to pace, spin not abandoned']
            ]
          },
          { type: 'text', content: '<p><strong>Middle-overs spin by season:</strong> 2023: 72.9% → 2024: 42.2% → 2025: 66.2%. The 2025 championship was built on the spin-control formula.</p>' },
          { type: 'subheading', content: 'Individual Bowling Maps' },
          { type: 'text', content: '<p><strong>Hazlewood</strong> is NOT PP-only. He bowled death in 67% of matches. Over 19: 6.75 economy, 5 wickets — his yorker over. <strong>Bhuvneshwar</strong> is PP + death (almost never middle overs). <strong>Suyash</strong> is pure middle-overs: 88% of balls in overs 7-15, best overs at 7 (5.83 econ) and 15 (6.33 econ). <strong>Krunal</strong> bowls 67.8% of overs in middle at 7.26 economy.</p>' },
          { type: 'subheading', content: 'The Bowling-First Template' },
          { type: 'text', content: '<p><strong>Overs 1-3:</strong> Hazlewood + Bhuvneshwar. Swing and seam. <strong>Overs 4-6:</strong> Second spells or Dayal. <strong>Overs 7-15:</strong> Krunal + Suyash take over (~60% spin). <strong>Overs 16-18:</strong> Return to pace. <strong>Overs 19-20:</strong> Hazlewood\'s death overs. This template barely changes between bowling first and defending. It\'s rigid, predictable, and it won the title.</p>' }
        ]
      },

      // ── 16. INTERESTING DATA INSIGHTS ─────────────────────────────
      {
        id: 'dataInsights',
        title: 'Interesting Data Insights',
        summary: 'Five data-driven insights: Kohli\'s death SR context, Patidar\'s leg-spin dominance, Jitesh\'s hidden value, Hazlewood\'s dot ball mastery, and the left-arm pace blind spot.',
        blocks: [
          { type: 'subheading', content: '1. Kohli\'s Death-Overs SR Is Real. But Read the Fine Print.' },
          ...
          { type: 'subheading', content: '2. Patidar vs. Leg-Spin Is a Mismatch, and Not in the Bowler\'s Favor' },
          ...
          { type: 'subheading', content: '3. Jitesh Sharma\'s Best Cricket Is Hiding Where It Matters Most' },
          ...
          { type: 'subheading', content: '4. Hazlewood\'s Dot Ball Rate Defies Logic' },
          ...
          { type: 'subheading', content: '5. The Left-Arm Pace Blind Spot Nobody\'s Talking About' },
