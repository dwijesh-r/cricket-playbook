...
| Death | Bat | YBK Jaiswal | 88 runs @ 209.5 SR | 42 balls |
| Death | Bat | Dhruv Jurel | 410 runs @ 179.0 SR | 229 balls |
| Death | Bowl | N Burger | Econ 4.33 (1 wkts) | 18 balls |
...
4. **Death hitting from YBK Jaiswal** — 209.5 SR in overs 16-20; maximizing the last 5 overs is the difference between 170 and 190+.
5. **N Burger's elite death bowling** — 4.33 economy at the death; defending totals requires yorker accuracy and nerve under pressure.
6. **Reduce top-order dependency** — top 3 contributed 54% of runs in 2025; middle order must step up to avoid batting collapses if openers fail.
