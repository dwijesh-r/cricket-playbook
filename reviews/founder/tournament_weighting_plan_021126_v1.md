...
**Metrics:**
- Run rate differential (tournament avg vs IPL avg)
- Boundary percentage comparison
- Wickets per over distance (absolute difference from IPL baseline)
...
### Strike Rate Differentials (vs IPL baseline)

| Tournament | SR Differential | Interpretation |
|------------|----------------|----------------|
| Vitality Blast | +5.7% | Higher-scoring environment |
| MLC | -1.5% | Very close to IPL conditions |
| T20 World Cup | -14.9% | Significantly lower-scoring; international pitches and pressure |

### Wickets Per Over

IPL has the **lowest** wickets per over of any major league at **0.31**, indicating that IPL batting conditions are the most batting-friendly among top-tier T20 leagues. This has direct implications for how we interpret bowling statistics from other tournaments.
